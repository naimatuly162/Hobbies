        ...
        <div class="modal-card">
            ...
            <section class="modal-card-body">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" :class="{'is-danger':errors.user_name}" type="number" placeholder="Phone" v-model="list.user_name">
                    </div>
...
export default{
    ...
    methods:{
        ...
        edit(){
            axios.patch(`/hobbies/${this.list.id}`,this.$data.list).then((response)=> this.close())
